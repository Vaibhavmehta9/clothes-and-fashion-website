      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-6">
        <div className="flex gap-4 md:gap-8 overflow-x-auto no-scrollbar py-4 px-2 snap-x snap-mandatory justify-start md:justify-center items-start">
          {[
            ...
            { name: 'Indianwear', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=200&q=80', link: '/products?category=ethnic-wear' },
            ...
            { name: 'Lingerie', image: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=200&q=80', link: '/products?category=women' },
